    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.IntegerField(default=1)),
                ('added_by_merchant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.merchantuser')),
            ],
        ),
        migrations.CreateModel(
            name='productVarient',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_varient_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.productvarient')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.subcategories'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('is_active', models.IntegerField(default=1)),
                ('product_review_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.productreviews')),
                ('user_id_vote', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='product_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.products'),
        ),
        migrations.CreateModel(
            name='adminUser',
            fields=[
